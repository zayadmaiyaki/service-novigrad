...
public class OfferedServicesForRequestActivity extends AppCompatActivity {
    private ListView selectServicesForRequestListView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_offered_services_for_request);

        selectServicesForRequestListView = findViewById(R.id.selectServiceForRequestListView);
        ...
        selectServicesForRequestListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            @Override
                ...
                serviceRef.orderByChild("name").equalTo(selectedServiceName).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists() && dataSnapshot.hasChildren()) {
                            ...
                            if (service != null) {
                                // Redirect to a new page and pass the service ID
                            ...
                            Toast.makeText(OfferedServicesForRequestActivity.this, "Service not found in the database.", Toast.LENGTH_LONG).show();
                        }
                    }

                    @Override
                    public void onCancelled(DatabaseError databaseError) {
                        Toast.makeText(OfferedServicesForRequestActivity.this, "Failed to load service details.", Toast.LENGTH_LONG).show();
                    }
                });
                return true;
            }
    ...
    private void loadOfferedServices(String branchId) {
        ...
        branchesRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            @Override
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(OfferedServicesForRequestActivity.this, "Failed to load services.", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
