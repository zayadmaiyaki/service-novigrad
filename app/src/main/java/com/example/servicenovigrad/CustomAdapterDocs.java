...
public class CustomAdapterDocs extends ArrayAdapter<String> {
    private Map<String, String> filledItems;

    public CustomAdapterDocs(Context context, List<String> items, Map<String, String> filledItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tvName = (TextView) convertView.findViewById(R.id.docsStatus);
